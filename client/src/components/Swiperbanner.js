      ...
      >
        <SwiperSlide>
          <div className="grid grid-rows-1">
            <h6 className="text-3 sm:text-4 font-semibold text-center text-[#EC2029]">
        ...
        <SwiperSlide>
          <div className="grid grid-rows-1">
            ...
            <h6 className="text-center text-4 font-bold text-[#ec2029]">
              <span className="text-[#000]">Đến</span> Tokyo (Narita)
            </h6>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="grid grid-rows-1">
            ...
            <h6 className="text-center text-4 font-bold text-[#ec2029]">
              <span className="text-[#000]">Đến</span> Seoul
            </h6>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="grid grid-rows-1">
            ...
            <h6 className="text-center text-4 font-bold text-[#ec2029]">
              <span className="text-[#000]">Đến</span> Kuala Lumpur
            </h6>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="grid grid-rows-1">
            ...
            <h6 className="text-center text-4 font-bold text-[#ec2029]">
              <span className="text-[#000]">Đến</span> Singapore
            </h6>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="grid grid-rows-1">
            ...
            <h6 className="text-center text-4 font-bold text-[#ec2029]">
              <span className="text-[#000]">Đến</span> Đài Bắc
            </h6>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="grid grid-rows-1">
            ...
            <h6 className="text-center text-4 font-bold text-[#ec2029]">
              <span className="text-[#000]">Đến</span> Perth
            </h6>
          </div>
        </SwiperSlide>
        <SwiperSlide>

      ...
      >
        <SwiperSlide>
          <div class="jss1093">
            ...
            <a
              href="https://www.vietjetair.com/vi/pages/bao-hiem-1619494868035"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                src="https://vj-prod-website-cms.s3.ap-southeast-1.amazonaws.com/skycare380x260vn1689666523556-1695094643503.webp"
                class="jss1026 jss1094 jss1027"
                alt="hot service"
              />
            </a>
            <div class=" jss1100 jss1099 jss1096 text-left">
              <p>
                <strong>An tâm trọn vẹn bay cùng Vietjet</strong>
              </p>
              <ul className="list-des">
                <li>
                  Các chương trình bảo hiểm hấp dẫn đến từ các đối tác bảo hiểm
                  uy tín của Vietjet
                </li>
        ...
        <SwiperSlide>
          <div class="jss1093">
            ...
            <div class=" jss1100 jss1099 jss1096 text-left">
              <p>
                <strong>
                  Vận chuyển Bắc - Trung - Nam siêu tốc, siêu tiện lợi
                </strong>
              </p>
              <ul className="list-des">
                <li>
        ...
        <SwiperSlide>
          <div class="jss1093">
            ...
            >
              <img
                src="https://vj-prod-website-cms.s3.ap-southeast-1.amazonaws.com/bannervj3802601691554683744-1695094655469.webp"
                class="jss1026 jss1094 jss1027"
                alt="hot service"
              />
            </a>
            <div class=" jss1100 jss1099 jss1096 text-left">
              <p>
                <strong>Ưu đãi dành cho chủ thẻ mới</strong>
              </p>
              <ul className="list-des">

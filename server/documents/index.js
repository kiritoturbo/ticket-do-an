...
<div class="box">
  ...
  <div class="ticket">
    ...
    <div class="content">
      <span class="jfk">${booking.address}</span>
      ...
      <span class="sfo">${booking.email}</span>
      
      <span class="jfk jfkslip">${booking.address}</span>
      ...
      <span class="sfo sfoslip">${booking.email}</span>
      <div class="sub-content">
        <span class="name">PASSENGER NAME<br><span>${booking.buyerName}</span></span>
        <span class="flight">FLIGHT N&deg;<br><span>${booking.buyerName}</span></span>
        <span class="seat">SEAT<br><span>45A</span></span>
        <span class="boardingtime">BOARDING ON<br><span>${booking.phoneNumber}</span></span>
            
         <span class="flight flightslip">FLIGHT N&deg;<br><span>${booking.dateOfBirth}</span></span>
